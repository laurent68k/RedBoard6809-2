...
//---------------------------------------------------------------------------
//  Memory map in accordance to SBC 6809 "RedBoard-2"
#define RAMSTART    0x0000
#define RAMSIZE     0x8000      //  32Kb

#define ACIA        0xA000		//	only 2 registers
#define PIA         0xA004		//	only 4 registers

#define ROMSTART    0xC000
#define ROMSIZE     0x4000      //  16 Kb
//---------------------------------------------------------------------------
- (id)initWithDelegate:(id)theDelegate {  
    ...
    if (self = [super init]) {
        ...
        //  ROM with ExBasRom Monitor
        [self->addressDecoder addCircuit: [[[EKRom8bits alloc]     initWithSizeAndContent:ROMSTART size:ROMSIZE content:@"CocoBasic"] autorelease]];
...
/*
 ...
 B000-BFFF FREE SPACE  (4K)
 
 C000-FFFF ROM Monitor (16K)
